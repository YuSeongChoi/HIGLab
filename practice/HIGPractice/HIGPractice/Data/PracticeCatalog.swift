...
enum PracticeCatalog {
    ...
    static let items: [FrameworkItem] = [
        ...
        makeItem(id: "observation", name: "Observation", description: "@Observable 상태 관리", phase: .appFrameworks, symbolName: "eye.fill", tint: .mint, completed: false, blogSlug: "observation", docsSlug: "observation", tutorialPath: "tutorials/observation", samplePath: "samples/CartFlow", aiDoc: "swiftui-observation.md"),
