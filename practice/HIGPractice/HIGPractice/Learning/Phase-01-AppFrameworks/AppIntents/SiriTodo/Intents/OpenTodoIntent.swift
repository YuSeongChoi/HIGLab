// 이 파일은 "앱 열기/포그라운드 전환" 관련 Intent를 모아둔 파일이다.
// 구성:
// - OpenSiriTodoIntent, OpenAddTodoIntent, OpenSettingsIntent, OpenStatisticsIntent: 특정 화면 열기
// - ViewTodoDetailIntent, EditTodoIntent: 선택한 할일을 앱에서 이어서 보기/편집
// - ContinueInAppError: 앱 전환이 필요한 상황 설명
// 참고:
// - 이 파일의 Intent는 위젯 전용이 아니라, 앱 화면 전환과 Shortcuts 연계를 위한 공용 Intent다.
import AppIntents
import SwiftUI
import Combine
...
/// `openAppWhenRun` 기반의 기본 AppIntent로 앱을 연다.
///
/// ## 사용 예시
/// - "시리야, 할일 앱 열어줘"
/// - "시리야, SiriTodo 실행해"
struct OpenSiriTodoIntent: AppIntent {
    
    // MARK: - 메타데이터
    
    /// 인텐트 제목
    nonisolated static let title: LocalizedStringResource = "SiriTodo 열기"
...
struct ViewTodoDetailIntent: AppIntent, ForegroundContinuableIntent {
    ...
    nonisolated static let title: LocalizedStringResource = "할일 상세 보기"
    ...
    nonisolated var needsToContinueInForegroundError: Error? {
...
struct EditTodoIntent: AppIntent, ForegroundContinuableIntent {
    ...
    nonisolated static let title: LocalizedStringResource = "할일 편집"
...
struct OpenAddTodoIntent: AppIntent {
    ...
    nonisolated static let title: LocalizedStringResource = "새 할일 추가 화면"
...
struct OpenSettingsIntent: AppIntent {
    ...
    nonisolated static let title: LocalizedStringResource = "설정 열기"
...
struct OpenStatisticsIntent: AppIntent {
    ...
    nonisolated static let title: LocalizedStringResource = "통계 화면 열기"
